...
namespace SenseWeather
{
    public class GattConstants
    {
        ...
        public static Guid UartServiceId = Guid.Parse("6e400001-b5a3-f393-e0a9-e50e24dcca9e");
        public static Guid UartRxCharacteristic = Guid.Parse("6e400002-b5a3-f393-e0a9-e50e24dcca9e");
        public static Guid UartTxCharacteristic = Guid.Parse("6e400003-b5a3-f393-e0a9-e50e24dcca9e");
    }
}
